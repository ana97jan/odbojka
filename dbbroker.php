<?php                            // na vezbama je bila database ja sam  je dbbroker nazvala
class DBBroker
{
     ...
     * @param string $db
     * @param int $port
     */                                                        // pravimo konstruktor sa kojom bazom se povezujemo 
    public function __construct($host, $username, $password, $db, $port = NULL)
    {
        if($port == NULL)
            $port = ini_get('mysqli.default_port');
                                                             // konnekcija sa bazom pravimo mysqllink            
        $this->_mysqli = new mysqli($host, $username, $password, $db, $port)
            or die('There was a problem connecting to the database');
                                                      // ako dodje do greske pri povezivanju postavi mi charset na utf8 i on ce 
                                                      // se preko ovoga automacki povezati
